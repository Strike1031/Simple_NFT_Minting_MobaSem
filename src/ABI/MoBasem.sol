...
*/
//https://rinkeby.etherscan.io/address/0x6194da6ceD35CeE92fBfC8f097fA9Ea626EEe5D7#code
...
contract MoBasem is ERC721Enumerable, Ownable {
    ...
    constructor(string memory BASEURI) ERC721(TOKEN_NAME, TOKEN_SYMBOL) {
        ...
        presaleLimit = 5;
        publicSaleLimit = 20;
        presalePrice = 5_000_000_000_000_000; // 0.005 ETH for presale
        publicSalePrice = 10_000_000_000_000_000; // 0.01 ETH for public sale
    }
